...
class Atlantic(CrawlSpider):
    ...
    print current_hour
    hname = "C:\lol\Atlantic-" + current_time + ".csv"
    ...
    start_urls = ["http://finance.yahoo.com/news/provider-the-atlantic/"]

    # Class collects front page information
    def __init__(self):
    ...
    def parse_page2(self, response):  # data stored
        ...
        Atlantic.writer.writerow([title.encode("utf-8"), subheadline.encode("utf-8"), source.encode("utf-8"), linktime.encode("utf-8"),
